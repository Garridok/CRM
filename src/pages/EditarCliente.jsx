...
//Conseguir los datos para autorellenar el formulario
export async function loader({params}) {
  const cliente = await obtenerCliente(params.clienteId);
  if(Object.values(cliente).length === 0) {
        throw new Response('', {
            status: 404,
            statusText: 'No existe ma G'
        })
  }
...
export async function action({request, params}){
  ...
  //ahora vamos a actualizar el cliente, una vez validado la informacion introducida
